...
title_component = html.H1(
    "Life Expectation by continent since 1980", className="text-center fw-bold mb-4"
)
...
output_component = dbc.Row(
    [
        dbc.Col(
            html.Span("The life expectation in", className="fw-bold"),
            width=5,
            style={"textAlign": "right"},
        ),
        dbc.Col(
            dbc.Badge(id="final-output", color="primary", className="fs-5"),
            width=7,
