...
app.layout = dbc.Container(
    [
        ...
        dbc.Row(
            [
                dbc.Col([dropdown_], className="col-12 col-md-2 p-3"),
                dbc.Col([graph_], className="col-12 col-md-10 h-75 border border-warning border-1 rounded-3"),
            ],
            className="flex-fill",
        ),
        dbc.Row(
            [
                dbc.Col([slider_1], className="col-12 col-md-4 mb-3 mb-md-0"),
                dbc.Col([slider_2], className="col-12 col-md-6"),
            ],
            justify="center",
            className="p-5",
        ),
