...
def update_chart(n_clicks, col, table_data):
    """Update chart when button is clicked or column is changed."""
    ...
    # Build chart only on button click or column change
...
@callback(
    ...
    Output("input-data", "selected_columns"),
    Input("reset-table", "n_clicks"),
    prevent_initial_call=True,
)
def reset_table(_n_clicks):
    """Reset the data table to its initial state and clear selections."""
    return INITIAL_DATA, None, ["tip"]
