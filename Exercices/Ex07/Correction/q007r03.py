...
TABLE_STYLES = {
    ...
    "style_data_conditional": [
        {"if": {"row_index": "odd"}, "backgroundColor": f"rgba(102, 126, 234, 0.05)"},
        {
    ...
    return dbc.Col(
        dbc.Card(
            [
                ...
                dbc.CardBody(content, style={**CARD_BODY_STYLE, "padding": "20px"}),
            ],
...
app.layout = dbc.Container(
    [
        ...
        dbc.Row(dbc.Col(button, width=12, lg=6, className="mx-auto"), className="mb-5"),
    ],
    fluid=True,
