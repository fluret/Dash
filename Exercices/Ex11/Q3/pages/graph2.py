        ...
        [
            ...
            dbc.CardBody(
                [
                    ...
                    html.Div(
                        id=f"{graph_id}-badges", className="d-flex gap-2 mt-2 flex-wrap"
                    ),
                ]
            ),
        ],
    ...
    [
        ...
        dbc.Row(
            [
                dbc.Col(
                    build_graph_card(
                        f"{ICON_CHART} Avant la date de début", "my-graph-left"
                    ),
                    md=4,
                    xs=12,
                    className="mb-3",
                ...
                dbc.Col(
                    build_graph_card(f"{ICON_CHART} Dans la plage", "my-graph-center"),
                    md=4,
                    xs=12,
                    className="mb-3",
                ),
                dbc.Col(
                    build_graph_card(
                        f"{ICON_CHART} Après la date de fin", "my-graph-right"
                    ),
                    md=4,
                    xs=12,
                    className="mb-3",
