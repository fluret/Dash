...
dash.register_page(
    __name__, order=1, name="Composants", title="Composants Dash Bootstrap"
)

layout = dbc.Container(
    [
        html.H1(
            "Aperçu des composants Dash Bootstrap Components",
            ...
            [
                dbc.Col(
                    [
                        ...
                        dbc.Button(
                            "Secondary", color="secondary", className="me-2 mb-2"
                        ),
                        ...
                        dbc.Card(
                            [
                                ...
                                dbc.CardBody(
                                    [
                                        html.H5(
                                            "Titre de la carte", className="card-title"
                                        ),
                                        html.P(
                                            "Ceci est un exemple de carte Bootstrap avec Dash.",
                                            className="card-text",
                                        ),
            ...
            [
                dbc.Col(
                    [
                        html.H5("Spinner"),
                        dbc.Spinner(
                            size="md", color="primary", spinnerClassName="me-2"
                        ),
                        dbc.Spinner(
                            size="md", color="secondary", spinnerClassName="me-2"
                        ),
                        dbc.Spinner(
                            size="md", color="success", spinnerClassName="me-2"
                        ),
                    ],
                    width=12,
                ),
