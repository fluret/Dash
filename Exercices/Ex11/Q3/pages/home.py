                                ...
                                dbc.ListGroup(
                                    [
                                        dbc.ListGroupItem(
                                            [
                                                html.I(
                                                    className="bi bi-lightning-charge-fill text-warning me-2"
                                                ),
                                                "Rapide et intuitive",
                                            ],
                                        ...
                                        dbc.ListGroupItem(
                                            [
                                                html.I(
                                                    className="bi bi-bar-chart-fill text-success me-2"
                                                ),
                                        ...
                                        dbc.ListGroupItem(
                                            [
                                                html.I(
                                                    className="bi bi-shield-lock-fill text-info me-2"
                                                ),
