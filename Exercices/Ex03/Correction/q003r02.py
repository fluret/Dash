...
# Label avec un style initial
label_component = dbc.Label('Text to modify', id='target-text', className=LABEL_CLASS, style={"fontVariant": "small-caps"})
...
def update_label(color, current_style):
